...
--
-- select proyectos.código
-- from proyectos,analistas inner join distribución on dni = dniemp as A
-- where código not in (select códigopr from A);
...
create view segundoTermino as

select avg(cociente) as media from (
